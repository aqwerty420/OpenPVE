...
export const unitBlacklist = new Dictionnary(unitBlacklistData);
export const unitStunBlacklist = new Dictionnary(unitStunBlacklistData);
export const kickCast = new Dictionnary(kickCastData);
export const kickChanneling = new Dictionnary(kickChannelingData);
export const kickChanneled = new Dictionnary(kickChanneledData);
export const stunCast = new Dictionnary(stunCastData);
